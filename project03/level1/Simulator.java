...
public class Simulator {
    ...
    public void simulate(int seed, int numberOfServers, int maxQueueLength,
        ...
        processCustomers(numberOfServers, events, maxQueueLength, rng);
    }
     ...
     */
    public void processCustomers(int numberOfServers,
            PriorityQueue<SimulatorEvent> events, int maxQueueLength,
            RandomGenerator rng) {
