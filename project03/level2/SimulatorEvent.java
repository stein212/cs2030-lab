...
public class SimulatorEvent implements Comparable<SimulatorEvent> {
    ...
    public String toString() {
        ...
        switch (status) {
            case WAITS:
                description = String.format("waits to be served by server %d",
                        server.getId());
                break;
            case SERVED:
                description = String.format("served by server %d",
                        server.getId());
                break;
            case DONE:
                description = String.format("done serving by server %d",
                        server.getId());
                break;
            default:
                // use enum name
